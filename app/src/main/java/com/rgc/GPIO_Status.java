...
public class GPIO_Status extends Fragment {
	static String dstName,dstAddress,dstPassword,encKey,model=android.os.Build.MODEL;
	...
	GridView gridView;Button r;DataBaseHelper myDbHelper; static int id_U;
    ...
    public static GPIO_Status newInstance(int page,String name, String address, int port, String password,Context Context, String enc_key,int artime, int id_u) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		gridView.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(final View v, MotionEvent event) {
				...
				if(event.getAction() == MotionEvent.ACTION_DOWN && !editMode) {
									...
									public boolean onMenuItemClick(MenuItem item) {
										switch (item.getItemId()) {
											case R.id.on:
												...
												String stan_ustaw="1";if(reverse.equals("1"))stan_ustaw = "0";
												Set_GPIO_State.execute("GPIO_set",idt,gpio,stan_ustaw,DatetoString(settime=new Date()),reverse,android.os.Build.MODEL);
												break;
											case R.id.off:
												...
												stan_ustaw="0";if(reverse.equals("1"))stan_ustaw = "1";
					...
					final String nazwaL = nazwy.get(position);final EditText name = (EditText) loginView.findViewById(R.id.name);name.setText(nazwaL);
					final String gpioL = gpios.get(position);final EditText gpioet = (EditText) loginView.findViewById(R.id.gpio);gpioet.setText(gpioL);
					final String reverseL = reverses.get(position);final CheckBox reversech = (CheckBox) loginView.findViewById(R.id.reverse);
					...
					actl.setAdapter(adapterbt);actl.setSelection(Integer.parseInt(types.get(position)));
						...
						public void onShow(DialogInterface dialog) {
							...
							b.setOnClickListener(new View.OnClickListener() {
								...
								public void onClick(View view) {
									...
									String reverseS = "0";if (reversech.isChecked())reverseS = "1";
        ...
        /*gridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View v,
            	...
            	if(stan.equals("0"))stan_ustaw="1";
            	else if (stan.equals("1"))stan_ustaw="0";
            	else if (stan.equals("2")){//stan_ustaw="0";
            	...
            	if(stan.equals("0")||stan.equals("1")){
            	GPIO_StatusTask Set_GPIO_State = new GPIO_StatusTask(new AsyncResponse(){
        		    @Override
        			public void processFinish(String output){
        		    	stany.set(position, output);
        ...
        gridView.setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, final View v,
                ...
                final String idt = idki.get(position);
                final String nazwaL = nazwy.get(position);final EditText name = (EditText) loginView.findViewById(R.id.name);name.setText(nazwaL);
            	final String gpioL = gpios.get(position);final EditText gpio = (EditText) loginView.findViewById(R.id.gpio);gpio.setText(gpioL);
            	final String reverseL = reverses.get(position);final CheckBox reverse = (CheckBox) loginView.findViewById(R.id.reverse);
                        ...
                        b.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
								...
								for (String temp : templist) {
                 	        	...
                 	        	Edit_Type.execute("Edit_GPIO_out",idt, gpio.getText().toString(), name.getText().toString(),DatetoString(new Date()), reverseS,gpioL);
	 ...
	 @Override
	  ...
	  protected Boolean doInBackground(String... params) {
		  ...
		  try {
			  ...
			  if(params[0].equals("GPIO_OEtime")) response = c.sendString(dstAddress, dstPort, dstPassword,params[0]+";",128,encKey);
			  else if(params[0].equals("GPIO_set")) response = c.sendString(dstAddress, dstPort, dstPassword,params[0]+";"+params[1]+";"+params[2]+";"+params[3]+";"+params[4]+";"+params[5]+";"+params[6],128,encKey);
			  else if(params[0].equals("Allpins_GPIO_pwm")) response = c.sendString(dstAddress, dstPort, dstPassword,params[0]+";",1024,encKey);
			  else if(params[0].equals("Allpins_GPIO_in")) response = c.sendString(dstAddress, dstPort, dstPassword,params[0]+";",1024,encKey);
			  else if(params[0].equals("GPIO_Olist"))response = c.sendString(dstAddress, dstPort, dstPassword,params[0]+";",16384,encKey);
			  else if(params[0].equals("Add_GPIO_out")) response = c.sendString(dstAddress, dstPort, dstPassword,params[0]+";"+params[1]+";"+params[2]+";"+params[3]+";"+params[4]+";"+params[5]+";"+android.os.Build.MODEL,1024,encKey);
			  else if(params[0].equals("Edit_GPIO_out")) response = c.sendString(dstAddress, dstPort, dstPassword,params[0]+";"+params[1]+";"+params[2]+";"+params[3]+";"+params[4]+";"+params[5]+";"+params[6]+";"+params[7]+";"+android.os.Build.MODEL,1024,encKey);
			  else if(params[0].equals("Delete_GPIO_out")) response = c.sendString(dstAddress, dstPort, dstPassword,params[0]+";"+params[1]+";"+params[2]+";"+params[3]+";"+android.os.Build.MODEL,256,encKey);
	  ...
	  protected void onPostExecute(Boolean result) {
		  ...
		  if (result == true && passwd == true){r.setTextColor(Color.GREEN);
			  if (list.get(1).equals("GPIO_OEtime")){
				  ...
				  idki.clear();gpios.clear();stany.clear();nazwy.clear();reverses.clear();types.clear();
