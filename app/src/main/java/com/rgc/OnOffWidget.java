...
public class OnOffWidget extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        final Intent i = new Intent(context, UpdateOnOffWidgetService.class);
        ...
        for (int j = 0; j < count; j++) {
            ...
            if (id_U != -1) {
                ...
                c.moveToFirst();
                remoteViews.setTextViewText(R.id.title, c.getString(1));
                ...
                remoteViews.setOnClickPendingIntent(R.id.refresh,OnOffWidgetConfActivity.getPendingSelfIntent(context, "REFRESH",widgetId));
                remoteViews.setPendingIntentTemplate(R.id.switches, OnOffWidgetConfActivity.getPendingSelfIntent(context, "SWITCH",widgetId));
                Intent inten1t = new Intent(context, OnOffRemoteViewService.class);
