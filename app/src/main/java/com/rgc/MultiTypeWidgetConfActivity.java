...
public class MultiTypeWidgetConfActivity extends Activity {
    int mAppWidgetId = AppWidgetManager.INVALID_APPWIDGET_ID;
    private Button btAdd;
    private Spinner conns,types;
        ...
        btAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(conns != null && conns.getSelectedItem() !=null){
                    ...
                    views.setOnClickPendingIntent(R.id.refresh,getPendingSelfIntent(MultiTypeWidgetConfActivity.this, "REFRESH",mAppWidgetId));
                    Intent inten1t;
                    switch (type){
                        case "On/Off Outputs":
                            views.setPendingIntentTemplate(R.id.switches, getPendingSelfIntent(MultiTypeWidgetConfActivity.this, "SWITCH",mAppWidgetId));
                            views.setTextViewText(R.id.title, c.getString(1) + " - On/Off Outputs");
                            inten1t = new Intent(getApplicationContext(), OnOffRemoteViewService.class);
                            break;
                        case "Sensors":
                            views.setPendingIntentTemplate(R.id.switches, getPendingSelfIntent(MultiTypeWidgetConfActivity.this, "REFRESH_SENSOR",mAppWidgetId));
                            views.setTextViewText(R.id.title, c.getString(1) + " - Sensors");
                            inten1t = new Intent(getApplicationContext(), SensorsRemoteViewService.class);
                            break;
                        case "Chains":
                            views.setPendingIntentTemplate(R.id.switches, getPendingSelfIntent(MultiTypeWidgetConfActivity.this, "CHAIN_EXE",mAppWidgetId));
                            views.setTextViewText(R.id.title, c.getString(1) + " - Chains");
                            inten1t = new Intent(getApplicationContext(), ChainsRemoteViewService.class);
                            break;
                        default:
                            inten1t = new Intent(getApplicationContext(), OnOffRemoteViewService.class);
...
//                    widgetManager.notifyAppWidgetViewDataChanged(mAppWidgetId,R.id.switches);
                    ...
                    editor.putString("TYPE"+mAppWidgetId,type);
                    editor.apply();
                    widgetManager.updateAppWidget(mAppWidgetId, views);
    ...
    static protected PendingIntent getPendingSelfIntent(Context context, String action, int mAppWidgetId) {
        Intent intent = new Intent(context, MultiTypeWidget.class);
