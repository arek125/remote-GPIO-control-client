...
public class GPIO_Pwm extends Fragment {
    ...
    public static GPIO_Pwm newInstance(int page,String name, Connection conn, Context Context, int artime, int id_u) {
    ...
    public static class GPIO_PwmTask extends AsyncTask<String, String, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            try {
                ...
                if (params[0].equals("GPIO_PEtime"))
                    response = c.sendString( params[0] + ";", 256);
                else if (params[0].equals("GPIO_Plist"))
                    response = c.sendString( params[0] + ";", 16384);
                else if (params[0].equals("GPIO_PDC"))
                    response = c.sendString( params[0] + ";" + params[1] + ";" + params[2] + ";" + params[3], 128);
                else if (params[0].equals("GPIO_PDCu"))
                    response = c.sendString( params[0] + ";" + params[1] + ";" + params[2] + ";" + params[3] + ";" + DatetoString(new Date()) + ";" + android.os.Build.MODEL, 512);
                else if (params[0].equals("GPIO_PFRDC"))
                    response = c.sendString( params[0] + ";" + params[1] + ";" + params[2] + ";" + params[3] + ";" + params[4] + ";" + DatetoString(new Date()) + ";" + android.os.Build.MODEL, 512);
                else if (params[0].equals("GPIO_PSS"))
                    response = c.sendString( params[0] + ";" + params[1] + ";" + params[2] + ";" + params[3] + ";" + DatetoString(new Date()) + ";" + params[4] + ";" + params[5] + ";" + android.os.Build.MODEL, 512);
                else if (params[0].equals("Add_GPIO_pwm"))
                    response = c.sendString( params[0] + ";" + params[1] + ";" + params[2] + ";" + params[3] + ";" + params[4] + ";" + params[5] + ";" + params[6] + ";" + android.os.Build.MODEL, 1024);
                else if (params[0].equals("Edit_GPIO_pwm"))
